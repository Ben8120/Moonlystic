        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <asp:Panel ID="PanelManageProducts" runat="server">
                    ...
                    <asp:TextBox ID="txtProdPrice" runat="server" placeholder="Product Price" TextMode="Number"></asp:TextBox>
                    <asp:TextBox ID="txtProdAmount" runat="server" placeholder="Product Amount" TextMode="Number"></asp:TextBox>
                    <asp:TextBox ID="txtProdDiscount" runat="server" placeholder="Product Discount" TextMode="Number"></asp:TextBox>
                    <asp:DropDownList ID="ddlProdCat" runat="server" OnSelectedIndexChanged="ddlProdCat_SelectedIndexChanged" DataSourceID="sqlCat" DataTextField="categoryName" DataValueField="categoryId"></asp:DropDownList>
